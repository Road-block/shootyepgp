...
Results will print here when done.]],
  ...
  ["Whisper me + for %s (mainspec)"] = true,
  ["Whisper me - for %s (offspec)"] = true,
  ["Whisper me + or - for %s (mainspec or offspec)"] = true,
...
完成后打印结果.]],
  ...
  ["Whisper me + for %s (mainspec)"] = "私聊我 + %s (主天赋)",
  ["Whisper me - for %s (offspec)"] = "私聊我 - %s (副天赋)",
  ["Whisper me + or - for %s (mainspec or offspec)"] = "私聊我 + 或者 - %s (主天赋或副天赋)",
