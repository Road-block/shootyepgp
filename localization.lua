...
完成后打印结果.]],
  ...
  ["Whisper %s a + for %s (mainspec)"] = "Whisper %s a + for %s (mainspec)", -- needs new translation
  ["Whisper %s a - for %s (offspec)"] = "Whisper %s a - for %s (offspec)", -- needs new translation
  ["Whisper %s a + or - for %s (mainspec or offspec)"] = "Whisper %s a + or - for %s (mainspec or offspec)", -- needs new translation
